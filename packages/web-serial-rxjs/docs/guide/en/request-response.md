...
Parent: [#535](https://github.com/gurezo/web-serial-rxjs/issues/535) · Issue: [#538](https://github.com/gurezo/web-serial-rxjs/issues/538) · Related: [Communication pattern Recipes](./recipes.md) · [Choosing receive$ / lines$ / terminalText$](./stream-selection.md) · [Hardware-free testing](./testing.md) · [Timeout / cancel / retry](./timeout-cancel-retry.md)
