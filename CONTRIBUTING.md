...
Hand-written Guide source and generated API Reference output are separated. See [Documentation Architecture](packages/web-serial-rxjs/docs/ARCHITECTURE.md) for the canonical layout.
...
- Public docs are published at `https://gurezo.net/web-serial-rxjs/` via `gurezo/portal` (this repo uploads a static artifact with [portal-static-artifact.yml](.github/workflows/portal-static-artifact.yml)). See [Documentation Architecture](packages/web-serial-rxjs/docs/ARCHITECTURE.md#public-hosting-151--361).
